...
interface AddPlantDialogProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onAddToGarden: (plantName: string, selectedIcon: string) => Promise<void>;
  originalImage?: File;
}
...
export function AddPlantDialog({ result, isOpen, onClose, onAddToGarden, originalImage }: AddPlantDialogProps) {
  ...
  const handleAddToGarden = async () => {
    ...
    try {
      await onAddToGarden(plantName.trim(), selectedIcon);
